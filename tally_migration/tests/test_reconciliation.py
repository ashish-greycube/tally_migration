...
from tally_migration.tally.extractors import AccountNode, ExtractedCOA, ExtractedMasters
from tally_migration.migration.reconciliation import source_totals, compare
...
class TestCumulativeOpeningsFlag(unittest.TestCase):
    ...
    def setUpClass(cls):
        try:
            from tally_migration.migration import master_migrator
