...
from tally_migration.tally.file_source import FileTallySource
from tally_migration.tally.extractors import TallyExtractor
from tally_migration.erpnext.importers.openings import PartyOpeningImporter
...
class TestReconciliationIncludesForexAccounts(unittest.TestCase):
    ...
    def test_opening_account_balance_accepts_account_list(self):
        from tally_migration.migration import reconciliation as R
        captured = {}
