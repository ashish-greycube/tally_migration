"""Tests for Chart-of-Accounts extraction + classification. Pure, runs locally:
    python -m unittest tally_migration.tests.test_coa
"""
import unittest

from tally_migration.tally.extractors import TallyExtractor
from tally_migration.tally.mappings import classify_group, is_system_ledger
from tally_migration.tally.resolver import LedgerResolver, CUSTOMER, SUPPLIER, ACCOUNT
