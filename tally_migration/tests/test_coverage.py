"""Tests for the field-coverage report. Pure, runs locally:
    python -m unittest tally_migration.tests.test_coverage
"""
import unittest
from unittest import mock

from tally_migration.migration import coverage as cov
from tally_migration.migration.coverage import (
