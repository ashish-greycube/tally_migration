...
from tally_migration.tests.utils import get_company, require_company, cleanup_test_records
...
class TestERPNextImporter(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        from tally_migration.erpnext.importers import ERPNextImporter
    ...
    def test_party_side_effect_hooks_suspended_and_restored(self):
        ...
        import importlib
        from tally_migration.erpnext.importers.party import (
    ...
    def test_lightweight_set_link_title_uses_get_value_not_get_doc(self):
        ...
        from tally_migration.erpnext.importers import party as P
    ...
    def test_link_title_lightweight_patches_and_restores(self):
        ...
        import importlib
        from tally_migration.erpnext.importers.party import _link_title_lightweight
    ...
    def test_party_import_does_not_fire_contact_integration_hooks(self):
        ...
        import importlib
        from tally_migration.erpnext.importers.party import _SUSPENDED_PARTY_HOOKS
    ...
    def test_resolve_state_prefers_gstin_then_ledger_then_pin(self):
        ...
        whole address."""
        from tally_migration.erpnext.importers import CustomerImporter
    ...
    def test_batch_id_scoping_for_shared_names(self):
        ...
        from tally_migration.naming import shared_batch_names, batch_id_for
        items = [
    ...
    def test_opening_row_uses_scoped_batch_no_for_shared_name(self):
        ...
        from tally_migration.erpnext.importers import StockOpeningImporter
        from tally_migration.erpnext.importers.base import ImportResult
    ...
    def test_batch_importer_scopes_shared_batch_id_per_item(self):
        ...
        from tally_migration.naming import safe_item_code
    ...
    def test_ensure_serial_batch_enabled_flips_setting_when_off(self):
        ...
        from tally_migration.erpnext.importers import StockOpeningImporter
        from tally_migration.erpnext.importers.base import ImportResult
        from tally_migration.erpnext.importers import openings
    ...
    def test_parse_expiry_formats(self):
        from tally_migration.erpnext.importers.batch import BatchImporter
    ...
    def test_colliding_group_keeps_ledger_and_rehomes_children(self):
        ...
        require_company()
        from tally_migration.erpnext.importers.accounts import AccountImporter
        from tally_migration.tally.extractors import AccountNode
    ...
    def test_import_result_as_dict_structure(self):
        from tally_migration.erpnext.importers import ImportResult
    ...
    def test_opening_balance_plug_warns_when_unbalanced(self):
        from tally_migration.erpnext.importers import OpeningBalanceImporter, ImportResult
    ...
    def test_item_code_collision_detected(self):
        ...
        from tally_migration.erpnext.importers import ItemImporter
    ...
    def test_supplier_group_derived_from_tally_parent(self):
        from unittest import mock
        from tally_migration.erpnext.importers import SupplierImporter
    ...
    def test_party_group_falls_back_to_default_when_absent(self):
        ...
        from unittest import mock
        from tally_migration.erpnext.importers import CustomerImporter
        from tally_migration.tally.mappings import DEFAULT_CUSTOMER_GROUP
        imp = CustomerImporter("_TMTest Co", "TC")
    ...
    def test_bank_creation_is_tracked_for_revert(self):
        from unittest import mock
        from tally_migration.erpnext.importers import banks
        from tally_migration.erpnext.importers.base import ImportResult
    ...
    def test_uom_category_creation_is_tracked_for_revert(self):
        from unittest import mock
        from tally_migration.erpnext.importers import units
        from tally_migration.erpnext.importers.units import UnitImporter
        from tally_migration.erpnext.importers.base import ImportResult
    ...
    def test_opening_balance_skipped_when_entry_exists(self):
        ...
        from tally_migration.erpnext.importers import OpeningBalanceImporter
    ...
    def test_purchase_opening_due_date_clamped_to_bill_date(self):
        ...
        from tally_migration.erpnext.importers import PartyOpeningImporter
    ...
    def test_extra_addresses_and_contacts_created(self):
        ...
        from unittest import mock
        from tally_migration.erpnext.importers import CustomerImporter, ImportResult
    ...
    def test_set_primary_links_batches_party_fields(self):
        ...
        import contextlib
        from unittest import mock
        from tally_migration.erpnext.importers import SupplierImporter, ImportResult
        ...
        with mock.patch("frappe.db.set_value",
                ...
                mock.patch("tally_migration.erpnext.importers.party.atomic",
    ...
    def test_opening_balance_skips_account_that_is_a_group_in_erpnext(self):
        ...
        require_company()
        from tally_migration.erpnext.importers.openings import OpeningBalanceImporter
        from tally_migration.erpnext.importers.base import ImportResult
        from tally_migration.tally.extractors import AccountNode
        from tally_migration.naming import company_scoped
    ...
    def test_batch_label_roundtrips_through_remark(self):
        ...
        from tally_migration.erpnext.importers import OpeningBalanceImporter as OBI
    ...
    def test_advance_payment_entry_is_idempotent_on_rerun(self):
        ...
        require_company()
        from tally_migration.erpnext.importers import PartyOpeningImporter
        from tally_migration.tally.extractors import BillAllocation
        ...
        from tally_migration.migration import reconciliation as recon
    ...
    def test_price_importer_reports_progress_per_item(self):
        ...
        from tally_migration.erpnext.importers.prices import PriceImporter
    ...
    def test_item_opening_qty_and_rate_helpers(self):
        ...
        from tally_migration.tally.extractors import TallyExtractor as TE
...
class TestCompanyBankAccountCompany(unittest.TestCase):
    ...
    def test_company_bank_account_uses_target_company_despite_wrong_default(self):
        from unittest import mock
        from tally_migration.erpnext.importers.banks import _insert_bank_account
        from tally_migration.erpnext.importers.base import ImportResult
...
class TestBomSecondaryItemsIntegration(unittest.TestCase):
    ...
    def test_secondary_items_created_with_type_and_allocation(self):
        from tally_migration.erpnext.importers.bom import BomImporter
