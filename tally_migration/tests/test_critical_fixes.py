...
(they import ``tally_migration.erpnext.importers``, which imports ``frappe``).
...
from tally_migration.erpnext import importers
from tally_migration.erpnext.importers import (
...
class TestPartyOpeningClassification(unittest.TestCase):
    ...
    def test_preview_classifier_matches_importer(self):
        ...
        from tally_migration.migration.account_mapping import _classify_party
